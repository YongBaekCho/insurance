...
def age_bmi_plt(data):
    ...
    plt.title('BMI by age range and gender')
...
def charge_age_plt(ser, df):
    ...
    df.plot(kind='scatter', x = 'age', y = 'charges', c = 'BMI', fontsize = 24, colormap = 'Purples')
...
def obese_by_sex(df):
    ...
    plt.title('Number of men and women by bmi')
...
def pie_chart(male, female):
    ...
    pie_2 = axes[1].pie(female, autopct='%1.1f%%', startangle=90)
